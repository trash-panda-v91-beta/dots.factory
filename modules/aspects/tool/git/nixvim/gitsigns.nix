{ dots, ... }:
{
  dots.tool._.git.includes = [ dots.tool._.git._.git-gitsigns ];
  dots.tool._.git._.git-gitsigns.homeManager = { ... }: {
    programs.nixvim = {
      plugins.gitsigns = {
        enable = true;
        ...
        settings = {
          ...
          # Jetpack geometry vocabulary (matches statusline & shell prompt).
          signs = {
            add          = { text = "▴"; };
            change       = { text = "●"; };
            delete       = { text = "▿"; };
