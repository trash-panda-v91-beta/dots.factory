{ dots, ... }:
{
  dots.tool._.nixvim.includes = [ dots.tool._.nixvim._."mini-pick" ];
  dots.tool._.nixvim._."mini-pick".homeManager = { pkgs, ... }: {
    programs.nixvim = {
      ...
      keymaps = [
        ...
        }
        {
          mode = "n";
          key = "<leader>fs";
          action.__raw = ''function() require("smartpick").setup() end'';
        }
        {
          mode = "n";
          key = "<leader>fw";
