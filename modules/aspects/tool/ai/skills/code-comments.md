---
name: code-comments
description: Rules for writing and pruning code comments and docstrings - only explain *why*, never *what*. Auto-fires alongside `coding` and any implementation work. Use when writing new code, adding a function/class/module, refactoring, cleaning up comments, reviewing docstrings, or when the user says "clean up comments", "are these comments necessary", "trim docstrings", or asks to remove inline explanations. Not for PR review comments (that's `review-comments`).
---
